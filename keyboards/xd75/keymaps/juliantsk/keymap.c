 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | Z      | X      | C      | V      | B      | MINUS  | SCROLL | FN     | PGUP   | PLUS   | K      | M      | ,      | .      | /      |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | SHIFT  | CTRL   | ALT    | ESC    | SPACE  | NL     | PRINT  | PAUSE  | PGDN   | SS     | SPACE  | TAB    | HOME   | END    | ENTER  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
  ...
  [_CO] = LAYOUT_ortho_5x15( /* COLEMAK */
    ...
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_PMNS, KC_PSCR, KC_NO,   KC_PGUP, KC_PPLS, KC_K,    KC_M,  KC_COMM, KC_DOT,  KC_SLSH,
    KC_LSFT, KC_LCTRL,KC_LGUI, MO(_NL), LSFT_T(KC_SPC),  KC_BSPC, KC_LALT,  KC_BRK,   KC_PGDN, MO(_SS), RSFT_T(KC_SPC),  KC_GESC,  KC_HOME, KC_END, KC_ENT
  ),
 ...
 */
  ...
  [_SS] = LAYOUT_ortho_5x15( /* SECONDARY & SYMBOL */
    ...
    KC_EQL, S(KC_MINS),  KC_PPLS, KC_PMNS, KC_BSLS,    _______, _______, _______, _______, _______, S(KC_LBRC),S(KC_RBRC),KC_LBRC, KC_RBRC,  TD(QUOTS),
 ...
 */
  ...
  [_NL] = LAYOUT_ortho_5x15( /* FUNCTION */
    ...
    _______, KC_UP, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_7,    KC_8,    KC_9,    _______,
    KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, _______, _______, _______, _______, KC_4,    KC_5,    KC_6,    KC_0,
