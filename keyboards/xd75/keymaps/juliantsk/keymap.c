 ...
 */
  ...
  [_SS] = LAYOUT_ortho_5x15( /* SECONDARY & SYMBOL */
    ...
    KC_TAB,  _______, _______, KC_ENT,  KC_LCBR, KC_NLCK, _______, _______, _______, _______, KC_RCBR, KC_BSPC, KC_LBRC, KC_RBRC, KC_QUOT,
    _______, _______, _______, KC_LPRN, _______, _______, _______, _______, _______, _______, _______, KC_RPRN, _______, _______, KC_BSLS,
