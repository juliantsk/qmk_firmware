 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | A      | R      | S      | T      | D      | PRINT  | P4     | P5     | P6     | HOME   | H      | N      | E      | I      | O      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | Z      | X      | C      | V      | B      | SCROLL | P1     | P2     | P3     | END    | K      | M      | ,      | .      | /      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LCTRL  | SUPER  | LALT   | =      | VOLUP  | ENTER  | NO     | P0     | P.     | BKSPC  | VOLDN  | PGUP   | RALT   | UP     | RCTRL  |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 ...
 */
  ...
  [_CO] = LAYOUT_ortho_5x15( /* COLEMAK */
    ...
    KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_PSCR, KC_P4,   KC_P5,   KC_P6,   KC_HOME, KC_H,     KC_N,      KC_E,    KC_I,    KC_O,
    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SLCK, KC_P1,   KC_P2,   KC_P3,   KC_END,  KC_K,     KC_M,      KC_COMM, KC_DOT,  KC_SLSH,
    KC_LCTL, KC_LGUI, KC_LALT, KC_EQL,  KC_VOLU, KC_ENT,  KC_NO,   KC_P0,   KC_PDOT, KC_BSPC, KC_VOLD,  KC_PGUP,   KC_RALT, KC_UP,   KC_RCTRL,
 ...
 */
  ...
  [_SS] = LAYOUT_ortho_5x15( /* SECONDARY & SYMBOL */
    ...
    KC_TAB,  _______, _______, KC_LPRN, KC_LCBR, _______, _______, _______, _______, _______, KC_RCBR, KC_RPRN, KC_LBRC, KC_RBRC, KC_BSLS,
